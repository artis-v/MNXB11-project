...
## [2024.11.01_2] Artis Vijups, Sebastian Magnusson, 17:36
...
- Updated `README.md` to mention `datasets/README.md`. 

### Fixed

- Applied the `.clang-format` rules to all relevant files.
